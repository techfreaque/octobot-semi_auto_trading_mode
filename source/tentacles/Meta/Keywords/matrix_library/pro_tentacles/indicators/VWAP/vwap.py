...
from tentacles.Meta.Keywords.matrix_library.pro_tentacles.pro_keywords.indicator_keywords.vwap_lib.vwap_library import (
...
async def get_VWAP(maker, indicator, evaluator):
    ...
    candle_source = await user_select_candle_source_name(
        maker, indicator, "Select VWAP Candle Source", "hlc3"
    )
    ...
    vwap_data = calculate_historical_VWAP(
        ...
        await get_candles_(maker, "volume"),
