...
async def get_candle_average(maker, indicator, evaluator):
    await allow_enable_plot(maker, indicator, "Plot candle average")
    ...
    data = (candle_high + candle_low + candle_close) / 3.0
    data_source = {
        "v": {
            "title": "Candle average",
            "data": data,
