...
from tentacles.Meta.Keywords.matrix_library.pro_tentacles.pro_keywords.indicator_keywords.divergences.divergence import (
    divergence_,
)
...
async def get_divergence(maker, evaluator):
    ...
    (
        ...
        base_data=base_data["low"]["pivots"],
        other_data=other_data["low"]["pivots"],
        base_values=base_data["low"]["pivots_val"],
        other_values=other_data["low"]["pivots_val"],
        base_source_data=base_data["low"]["values"],
        other_source_data=other_data["low"]["values"],
