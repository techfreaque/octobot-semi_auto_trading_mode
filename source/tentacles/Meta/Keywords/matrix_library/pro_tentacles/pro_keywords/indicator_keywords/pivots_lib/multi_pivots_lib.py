...
#
#                 for candle_low_nr in range(1, len(current_timeframe_pivots["time"]) + 1):
#                     candle_time = current_timeframe_pivots["time"][-candle_low_nr]
...
#
#         #
#         # for candle_high_nr in range(1, len(current_timeframe_pivots["time"])):
#         #     candle_time = current_timeframe_pivots["time"][-candle_high_nr]
