...
import tentacles.Meta.Keywords.matrix_library.pro_tentacles.pro_keywords.orders.managed_order_pro.daemons.ping_pong.ping_pong_storage.group as ping_pong_group
import tentacles.Meta.Keywords.matrix_library.pro_tentacles.pro_keywords.orders.managed_order_pro.daemons.ping_pong.ping_pong_storage.element as element
...
class PingPongStorage:
    ...
    async def get_entry_order(
        ...
        try:
            ...
            if retry_counter <= RETRY_GET_ENTRY_ORDER_ATTEMPTS_COUNT:
                retry_counter += 1
